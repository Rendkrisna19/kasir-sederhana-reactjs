  ...
  return (
    ...
    <div className="fixed-bottom d-none d-md-block">
      <Row>
        <Col md={{ span : 3, offset : 9 }} className="px-4">
          ...
          <Button variant='danger' className='w-100 mb-2 mt-2' size="lg" onClick={() => submitTotalPay(totalPay)}> 
    ...
    <Row>
      <Col md={{ span : 3, offset : 9 }} className="px-4">
        ...
        <h4>Total Harga : <strong className='float-right mr-2'>Rp. {numberWithCommas(totalPay)}</strong></h4>
        <Button variant='danger' className='w-100 mb-2 mt-2 text-white' size="lg" onClick={() => submitTotalPay(totalPay)}> 
          <FontAwesomeIcon icon={faShoppingCart} /> Bayar Sekarang
        </Button>
      </Col>
    </Row>
